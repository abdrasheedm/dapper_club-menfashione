...
class Product(models.Model):
    ...
    image2                 = models.ImageField(upload_to='photos/products', null=True)
    image3                 = models.ImageField(upload_to='photos/products', null=True)
    image4                 = models.ImageField(upload_to='photos/products', null=True)
