"""
Django settings for dapper_club project.
...
SECRET_KEY = 'django-insecure-=jkp(05u^4^j#oj^a6np=jpa5o*3tn-!j%6d4i282$i^%7mswy'
...
WSGI_APPLICATION = 'dapper_club.wsgi.application'
